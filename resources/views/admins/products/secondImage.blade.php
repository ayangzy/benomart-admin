            ...
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              ...
              <!-- form start -->
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('products.updateSecondImage', $product->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="productImage2" class="col-sm-2 col-form-label">Product Image2</label>
                            <div class="col-md-10">
                                <img src="{{ asset($product->productImage2) }}" width="60">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="productImage2" class="col-sm-2 col-form-label">New Product Image2</label>
                            <div class="col-md-10">

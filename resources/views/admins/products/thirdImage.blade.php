            ...
            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              ...
              <!-- form start -->
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('products.updateThirdImage', $product->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="productImage3" class="col-sm-2 control-label">Product Image1</label>
                            <div class="col-md-10">
                                <img src="{{ asset($product->productImage3) }}" width="60">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="productImage3" class="col-sm-2 control-label">New Product Image1</label>
                            <div class="col-md-10">
